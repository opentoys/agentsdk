...
import (
	...
	"github.com/opentoys/agentsdk/modules/stdlib/httpx"
	"golang.org/x/oauth2"
)
...
type StreamableHTTPOptions struct {
	...
	CrossOriginProtection *httpx.CrossOriginProtection
}
...
func NewStreamableHTTPHandler(getServer func(*http.Request) *Server, opts *StreamableHTTPOptions) *StreamableHTTPHandler {
	...
	if h.opts.CrossOriginProtection == nil && enableoriginverification == "1" {
		h.opts.CrossOriginProtection = &httpx.CrossOriginProtection{}
	}
